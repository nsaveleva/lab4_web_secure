...
Злоумышленник также может попытаться перехватить трафик между клиентом и сервером. Если ему удастся словить момент авторизации пользователя, тогда он сможет узнать его пароль.
...
Удаленные приложения по ссылкам  https://nsaveleva.github.io/lab4_web_secure/web/ и https://saveleva.ml/ по умолчанию работают по https протолколу. 